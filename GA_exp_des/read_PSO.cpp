...
extern "C" {
void DATIN(int &iterm, int *triang, double *x, double *y, double *permx,
...
extern "C" {
void OPENIO(int &iterm);
}

extern "C" {
void CLOSIO(int &iterm);
}
/*
extern "C" {
...
*/
extern "C"{
void AREBAS(int &n, int &nt, int *triang, int *ip3, double *bi,
double *ci, double *areanod, double *area, double *arear, int *iarea,
double *x, double *y, int &iterm);
}

extern "C"{
void INIT0R(int &num, double *rvec);
}

extern "C"{
void AREAS(int *ip3, int *triang, double *x, double *y, double &are);
}

extern "C"{
void BASIS2(int *ip3, int *triang, double *x, double *y, double *bi,
double *ci);
}

extern "C"{
void STRPIC(int &n, int &nterm, int *triang, int *ja, int *topol,
int &nt, int &n1, int &imax, int &iterm);
}

extern "C"{
void CHKPIC(int &n, int &nterm, int *topol, int *ja, int &ndz, int *ier);
}

extern "C"{
void TRIPIC(int &nt, int *triang, int *ja, int *topol, int *trija);
//void tripic_(int &nt, std::unique_ptr<int> *triang, int *ja, int *topol, int *trija);
}

extern "C"{
void LOCMAS(double *lmass, int &lump);
//void locmas_(std::unique_ptr<double> &lmass, int &lump);
}

extern "C"{
void NODELT(int &nt, int *triang, double *vnod, double *velt);
}

extern "C"{
void INIT0I(int &num, int *ivec);
}
...
DATIN(iterm, triang, x, y, permx, permy, elstor, spess, contp, contq,
...
AREBAS(n, nt, triang, ip3, bi, ci, areanod, area, arear, iarea, x, y, iterm);
...
int *ier = &ier2[0];
STRPIC(n, nterm, triang, ja, topol, nt, n1, imax, iterm);
CHKPIC(n, nterm, topol, ja, ndz, ier);
TRIPIC(nt, triang, ja, topol, trija);
...
NODELT(nt, triang, x, xc);
//std::cout << "nodelt y" << std::endl;
NODELT(nt, triang, y, yc);
